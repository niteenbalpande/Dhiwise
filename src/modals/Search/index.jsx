      ...
      <div className="max-h-[97vh] overflow-y-auto sm:w-full md:w-full">
        <div className="bg-white-A700 flex flex-col gap-[50px] items-start justify-start max-w-[1290px] mb-[549px] mt-7 mx-auto p-[41px] md:px-5 rounded-[30px] w-full">
          ...
          <div className="flex flex-col gap-[27px] items-start justify-start mb-1 md:ml-[0] ml-[19px] rounded-[10px] w-[71%] md:w-full">
            ...
            <div className="flex sm:flex-col flex-row sm:gap-5 items-baseline justify-around rounded-[10px] w-full">
              <Button
                className="!rounded-[10px] block cursor-pointer leading-[normal] min-w-[86px] text-center text-lg tracking-[-0.50px]"
                shape="round"
                color="bluegray_900"
                size="sm"
              >
              ...
              <Button
                className="!rounded-[10px] block cursor-pointer leading-[normal] min-w-[94px] relative text-center text-lg tracking-[-0.50px]"
                shape="round"
                color="gray_50"
                size="sm"
              >
